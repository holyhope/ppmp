...
@Table(name = "hobby")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Hobby.findAll", query = "SELECT h FROM Hobby h"),
		...
		@NamedQuery(name = "Hobby.findByLabelLike", query = "SELECT h FROM Hobby h WHERE h.label LIKE :label") })
