...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Experiences.findAll", query = "SELECT e FROM Experiences e"),
...
public class Experiences implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.experiencesPK == null && other.experiencesPK != null)
				|| (this.experiencesPK != null && !this.experiencesPK.equals(other.experiencesPK))) {
			return false;
		}
		return true;
	}
